		...
		return (
			<td
				{ ...css(
					...
					modifiers.has('booked-half-day') && styles.CalendarDay__halfDay_booked,
					modifiers.has('unavailable-half-day') && styles.CalendarDay__halfDay_unavailable,
...
export default withStyles(({ reactDates: { color, font } }) => ( {
	...
	// These do not seem to work. We've set them through our own css
	CalendarDay__halfDay_booked: {
